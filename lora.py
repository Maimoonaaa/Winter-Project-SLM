...
def apply_lora_to_module(module, target_names=("qkv", "proj", "fc", "proj"), r=8, alpha=16, inject_in_mlp=False):
    """
    Traverses module children and wraps matching nn.Linear layers with LoRALinear.
    target_names: substrings to match for modules to wrap (e.g., 'qkv', 'proj', 'fc')
    inject_in_mlp: whether to add LoRA to MLP linear layers (fc and proj)
    """
